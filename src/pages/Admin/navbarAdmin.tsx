      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center">
            ...
            <div>
            <h4 className="ml-2 text-indigo-800 font-['Poppins', sans-serif]">Jill Valentine</h4>
            <p className="text-xs ml-5 text-gray-700 font-['Poppins', sans-serif]">Administrador</p>
      ...
      <div className="sm:hidden" id="mobile-menu">
        ...
        <div className="pt-4 pb-3 border-t border-gray-200">
          ...
          <div className="mt-3 space-y-1">
            <Link
              to="FALTA PERFIL DEL ADMI"
              className="block px-4 py-2 text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100"
            >
              Perfil
            </Link>
            <Link
              to="FALTAN AJUSTES DEL ADMI"
              className="block px-4 py-2 text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100"
            >
              Ajustes
            </Link>
